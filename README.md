...
```bash
git clone https://github.com/your-username/NeWs_PaPer_ArTiCLE_SUmmaRiZER.git
cd NeWs_PaPer_ArTiCLE_SUmmaRiZER
```
...
## 🖼 Screenshots
### Figure 1 : Main interface after launching the application
![jj](https://github.com/user-attachments/assets/884cceee-6369-4049-8145-198a7383b425)
### Figure 2 : URL input for article summarization
![jj1](https://github.com/user-attachments/assets/539d81c4-cace-4aae-887e-cd7b108bfd60)
### Figure 3 : Summary with metadata including title, author, date, keywords, word count, and sentiment
![jj2](https://github.com/user-attachments/assets/c60660b6-7a5b-42d2-8321-ecab47a0abf7)
### Figure 4 : This figure displays keywords and total word count display
![jj3](https://github.com/user-attachments/assets/96b6f725-206f-4df3-9c22-851faab98d68)
### Figure 5 : Users can save the summary and article details to a text file, also users can reset all fields to prepare for a new URL, Dark Mode Toggle to switch between light and dark modes
